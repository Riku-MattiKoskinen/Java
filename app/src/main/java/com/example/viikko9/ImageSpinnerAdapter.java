...
public class ImageSpinnerAdapter extends ArrayAdapter<ImageItem> {

    public ImageSpinnerAdapter(@NonNull Context context, int resource, @NonNull List<ImageItem> objects) {
